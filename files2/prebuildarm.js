...
function getUrl(platform, version, artifact) {
  ...
  const githubReleaseUrlBase = `https://github.com/Martin8617/Defi-Node-for-Raspberry-Pi/releases/download/v${version}`;
...
function getPlatformUrlSuffix(platform) {
  switch (platform) {
    case 'armv7l':
      return 'armv7l-raspi.tar.gz';
    case 'arm64':
      return 'arm64-raspi.tar.gz';
    default:
